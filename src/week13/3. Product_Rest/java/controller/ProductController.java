    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("list".equals(action)) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/week13/3. Product_Rest/list.jsp");
                ...
                if (product != null) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/week13/3. Product_Rest/detail.jsp");
                    rd.forward(request, response);
                } else {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/week13/3. Product_Rest/form.jsp");
                rd.forward(request, response);
            } else {
                response.sendRedirect("list");
            }
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/week13/3. Product_Rest/error.jsp");
            rd.forward(request, response);
        }
    }
